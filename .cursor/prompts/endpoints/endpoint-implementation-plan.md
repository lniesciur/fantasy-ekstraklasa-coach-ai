...
@backend.mdc
- do not create controllers, the last layer is application
</implementation_rules>
...
Pamiętaj, aby zapisać swój plan wdrożenia jako .ai/{nazwa}-implementation-plan.md. Upewnij się, że plan jest szczegółowy, przejrzysty i zapewnia kompleksowe wskazówki dla zespołu programistów.